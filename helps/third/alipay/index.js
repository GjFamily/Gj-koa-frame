...
var Client = function({ server_url, app_id, private_key, alipay_public_key, sign_type, encryptKey, encryptType }) {
  this.server_url = server_url;
  this.app_id = app_id;
  this.private_key = private_key;
  this.connectTimeout = 3000;
  this.readTimeout = 15000;
  this.sign_type = sign_type ? sign_type : "RSA2";
  this.alipay_public_key = alipay_public_key;
  this.encryptKey = encryptKey ? encryptKey : "AES";
...
Client.prototype.getSignature = function(data) {
  let content = this.getSignContent(data);
